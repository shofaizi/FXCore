...
const Auth = require('./utils/auth')(localStorage.getItem('userToken'));
...
ReactDOM.render((
  <Router history={browserHistory}>
    <Route path='/' component={App}>
      ...
      <Route path='fx' component={FxLayout} onEnter={Auth}></Route>
      <Route path='news' component={News} onEnter={Auth}></Route>
